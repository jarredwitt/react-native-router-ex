...
class Modal extends Component {
  ...
  shouldComponentUpdate(nextProps) {
    if (nextProps.show !== this.state.show || nextProps.navState.index !== this.props.navState.index) {
      return true;
    }
  ...
  render() {
    ...
    return (
      <Animated.View style={[{ position: 'absolute', top, left, overflow: 'hidden', height, width: displayWidth, backgroundColor: 'white' }]}>
        {this.state.children}
      </Animated.View>
    );
  }
