...
class Router extends Component {
  ...
  render() {
    ...
    return <TabController navState={this.props.navState} dispatch={this.context.store.dispatch} initialScene={this.props.initialScene} scenes={scenes.splice(1, scenes.length)} { ...scene } />;
  }
